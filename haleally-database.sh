...
# Create Table
mysql -u"$SQLUSER" -p"$SQLPASS" -e "CREATE TABLE $TABLE (ID Date TIMESTAMP, ANSWER1 VARCHAR(255), ANSWER2 VARCHAR(255), ANSWER3 VARCHAR(255), ANSWER4 NUMERIC(5,2), ANSWER5 VARCHAR(255)); ALTER TABLE $TABLE ADD PRIMARY KEY (ID);" $DATABASE
